export const timelineData = [
  ...
  },
  {
    ...
    description: `
    • Full-stack development on the Feedback Team, enhancing user feedback features like the feedback window in Office 365.\n
    • Developed and maintained applications using C++, TypeScript, and JavaScript with React.\n
    • Contributed to improving the user experience by designing scalable and efficient solutions for cross-platform feedback systems.
    `,
  },
];
